...
module.exports = function (grunt) {
  ...
  grunt.config.init({
    ...
    meta: {
      version: '<%= pkg.version %>',
      banner: '// jQuery.documentSize, v<%= meta.version %>\n' +
    ...
    preprocess: {
      build: {
        files: {
          'dist/jquery.documentsize.js': 'src/jquery.documentsize.js',
          'dist/amd/jquery.documentsize.js': 'src/amd.js'
        }
      },
      interactive: {
        files: {
    ...
    concat: {
      ...
      build: {
        ...
        dest: 'dist/jquery.documentsize.js'
      },
      amd_banner: {
        src: 'dist/amd/jquery.documentsize.js',
        dest: 'dist/amd/jquery.documentsize.js'
      }
    },
    ...
    uglify: {
      ...
      amd: {
        src: 'dist/amd/jquery.documentsize.js',
        dest: 'dist/amd/jquery.documentsize.min.js'
      },
      core: {
        src: 'dist/jquery.documentsize.js',
        dest: 'dist/jquery.documentsize.min.js'
      }
    },
